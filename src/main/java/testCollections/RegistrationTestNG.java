...
public class RegistrationTestNG {
 ...
 WebDriver driver1;	
	...
	public void reg1() throws InterruptedException{
		...
		driver.findElement(
				By.xpath("//input[@name='account_email']")).sendKeys("selenium20@mailinator.com");
		driver.findElement(
	...
	public void regStep2() throws InterruptedException, AWTException{
		driver.findElement(
				By.xpath("//input[@name='name']")).sendKeys("Fits19");
	...
	public void regStep3() throws InterruptedException{
		...
		driver1.findElement(
				By.xpath("html/body/p[5]/a")).click();
	}
